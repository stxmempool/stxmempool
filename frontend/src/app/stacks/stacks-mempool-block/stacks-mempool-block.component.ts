...
@Component({
  selector: 'app-stacks-mempool-block',
  templateUrl: './stacks-mempool-block.component.html',
  styleUrls: ['./stacks-mempool-block.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StacksMempoolBlockComponent implements OnInit, OnDestroy {
