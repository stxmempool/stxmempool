...
@Component({
  selector: 'app-stacks-block-preview',
  templateUrl: './stacks-block-preview.component.html',
  styleUrls: ['./stacks-block-preview.component.scss']
})
export class StacksBlockPreviewComponent implements OnInit, OnDestroy {
  network = '';
  block: BlockExtended;
  blockHeight: number;
  blockHash: string;
