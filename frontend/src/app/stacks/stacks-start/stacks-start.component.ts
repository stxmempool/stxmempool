...
@Component({
  selector: 'app-stacks-start',
  templateUrl: './stacks-start.component.html',
  styleUrls: ['./stacks-start.component.scss'],
})
export class StacksStartComponent implements OnInit, OnDestroy {
  interval = 60;
