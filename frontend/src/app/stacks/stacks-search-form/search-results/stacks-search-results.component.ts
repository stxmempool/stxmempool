...
@Component({
  selector: 'app-stacks-search-results',
  templateUrl: './stacks-search-results.component.html',
  styleUrls: ['./stacks-search-results.component.scss'],
})
export class StacksSearchResultsComponent implements OnChanges {
  @Input() results: any = {};
