...
@Component({
  selector: 'app-stacks-block-overview-graph',
  templateUrl: './stacks-block-overview-graph.component.html',
  styleUrls: ['./stacks-block-overview-graph.component.scss'],
})
export class StacksBlockOverviewGraphComponent implements AfterViewInit, OnDestroy, OnChanges {
